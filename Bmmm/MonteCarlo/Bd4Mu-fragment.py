...
_generator = cms.EDFilter(
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            list_forced_decays     = cms.vstring('MyB0', 'MyAntiB0'),        
...
cmsDriver.py Configuration/GenProduction/python/Bd4Mu-fragment.py \
--python_filename Bd4Mu_GEN_cfg.py \
--eventcontent RAWSIM \
--customise Configuration/DataProcessing/Utils.addMonitoring \
--datatier GEN \
--fileout file:Bd4Mu_GEN.root \
...
#############################
cmsDriver.py Configuration/GenProduction/python/Bd4Mu-fragment.py \
--python_filename Bd4Mu_GENSIM_cfg.py \
--eventcontent RAWSIM \
--customise Configuration/DataProcessing/Utils.addMonitoring \
--datatier GEN-SIM \
--fileout file:Bd4Mu_GENSIM.root \
--conditions 124X_mcRun3_2022_realistic_v12 \
--beamspot Realistic25ns13p6TeVEarly2022Collision \
--step GEN,SIM \
--geometry DB:Extended \
