...
DAS_QUERY = 'dataset dataset=/ParkingDoubleMuonLowMass*/Run2025*PromptReco*/MINIAOD'
...
# Config factory
# ------------------------------------------------------------------------------------
def create_config(dataset, outdir, dataset_tag, request_name, pset, workarea='crab_skims_02jul26_data2025_v2', site='T2_CH_CSCS'):
...
if __name__ == '__main__':
    ...
    pset   = 'vertex_refitter_data_2025_cfg.py'   # <-- DATA pset, Run3 data GT (see note)
