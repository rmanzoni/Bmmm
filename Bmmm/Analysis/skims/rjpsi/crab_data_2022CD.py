...
# varies per (part, era) (e.g. LowMass7 Run2022G is -v4, LowMass2 Run2022F is -v2, ...),
...
# datasets we want (Run2022I legitimately has two: '-vN' and '_v2-v2'). If a NEW
...
DAS_QUERY = 'dataset dataset=/ParkingDoubleMuonLowMass*/Run2022*MINIv6NANOv15*/MINIAOD'
EXPECTED_DATASETS = 24   # 8 parts x 8 (C,D,E,F,G,H,I,I_v2) -- update if the campaign changes
...
def dataset_suffix(dataset):
    ...
    Example:
      /ParkingDoubleMuonLowMass5/Run2022I-MINIv6NANOv15-v2/MINIAOD
        -> ParkingDoubleMuonLowMass5_Run2022I_MINIv6NANOv15_v2
      /ParkingDoubleMuonLowMass5/Run2022I-MINIv6NANOv15_v2-v2/MINIAOD
        -> ParkingDoubleMuonLowMass5_Run2022I_MINIv6NANOv15_v2_v2
    (The old (short, era, ext, ver) tuple collapsed both of these to 'Run2022I_v2'.)
    '''
...
# Config factory
# ------------------------------------------------------------------------------------
def create_config(dataset, outdir, dataset_tag, request_name, pset, workarea='crab_skims_02jul26_data2022_v2', site='T2_CH_CSCS'):
    ...
    #config.Data.lumiMask                   = 'Cert_Collisions2022_..._Golden.json'  # see note below
...
if __name__ == '__main__':
    ...
    pset   = 'vertex_refitter_data_2022CD_cfg.py'   # <-- DATA pset, Run3 data GT (see note)
