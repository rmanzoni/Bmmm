...
EXPECTED_DATASETS = 8   # 8 parts x 8 (C,D,E,F,G,H,I,I_v2) -- update if the campaign changes
...
if __name__ == '__main__':
    ...
    pset   = 'vertex_refitter_data_2022E_cfg.py'   # <-- DATA pset, Run3 data GT (see note)
