...
#     # che palle
#     skimmed_rdf = ROOT.RDataFrame(rdf)
#     skimmed_rdf = skimmed_rdf.Filter('HLT_DoubleMu4_3_Jpsi>0.5 && %s_HLT_DoubleMu4_3_Jpsi_tag>0.5 && mass<10' %tag)
#     
#     print (tag, probe)
#     print ([icol for icol in rdf_data.GetColumnNames() if icol=='tag_mu_pt'])
#     print ([icol for icol in skimmed_rdf.GetColumnNames() if icol=='tag_mu_pt'])
...
#         skimmed_rdf = skimmed_rdf.Define('probe_mu_%s' %ibranch, '%s_%s' %(probe, ibranch))
#         
#     skimmed_rdf.Snapshot('tree', '/pnfs/psi.ch/cms/trivcat/store/user/manzoni/rjpsi_sf/charmonium_ul2018_tag_%s_HLT_DoubleMu4_3_Jpsi.root' %tag)
#     del skimmed_rdf
# 
# snapshot_rdf('mu2', 'mu1', rdf_data)
# snapshot_rdf('mu1', 'mu2', rdf_data)
...
#         skimmed_rdf = skimmed_rdf.Define('probe_mu_%s' %ibranch, '%s_%s' %(probe, ibranch))
#         
#     skimmed_rdf.Snapshot('tree', '/pnfs/psi.ch/cms/trivcat/store/user/manzoni/rjpsi_sf/hb_tag_%s_HLT_DoubleMu4_3_Jpsi.root' %tag)
#     del skimmed_rdf
# 
# snapshot_rdf('mu2', 'mu1', rdf_data)
# snapshot_rdf('mu1', 'mu2', rdf_data)
