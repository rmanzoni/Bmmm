...
python3 apply_dxy_correction_and_validation.py \
    --data charmonium_2018_24may2026.root --mc hb_2018_24may2026.root \
    --json sigma_dxy_morph_v2.json --name mu2_bs_dxy_e_morph \
...
PT_BINS = [7.0, 8.0, 10.0, 15.0, 20.0, 50.0]
