...
directory = 'B4Mu_ntuples_ParkingDoubleMuonLowMass_Run2022C_PromptReco_v1_15feb24_v0'
...
for ifile in files:
    ...
    idx = int(ifile.replace('logger_b4m_data_chunk', '').replace('.txt', ''))
    tree = ROOT.TChain('tree')
    tree.Add('/pnfs/psi.ch/cms/trivcat/store/user/manzoni/%s/b4m_data_chunk%d.root' %(directory, idx))
