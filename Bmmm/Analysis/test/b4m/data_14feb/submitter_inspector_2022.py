...
to_resubmit = {}
to_resubmit['Run2022C-PromptReco-v1'] = [48, 50, 129, 133, 163, 164, 240, 241, 243, 381, 413, 506, 529]
to_resubmit['Run2022D-PromptReco-v1'] = []
to_resubmit['Run2022D-PromptReco-v2'] = []
to_resubmit['Run2022E-PromptReco-v1'] = [194, 271, 292, 295, 300, 301, 302, 304, 306, 314, 418, 436]
to_resubmit['Run2022F-PromptReco-v1'] = [85, 159, 341, 428, 559, 560, 810, 815, 816, 817, 819, 1359]
...
for iperiod in periods:
    ...
    out_dir = 'B4Mu_ntuples_ParkingDoubleMuonLowMass_%s_%s_v%d' %(iperiod.replace('-', '_'), time_tag, version)
