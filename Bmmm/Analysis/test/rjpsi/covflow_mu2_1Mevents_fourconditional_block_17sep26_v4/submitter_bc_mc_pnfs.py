...
# out_dir = 'RJpsi_15Sep2026_notrig_BcToJPsiMuMu_inclusive_v1'
out_dir = 'RJpsi_17Sep2026_notrig_BcToJPsiMuMu_inclusive_covflow_v1'
...
#     if ijob>2: break
    ...
    for idx, ifile in enumerate(ichunk):
        to_write += (
            ...
            '--savenontrig '
            '--covflow {this_dir}/mu2_1Mevents_fourconditional_block_17sep26_v4/task_0 '
            '--mc '
            '--skim '
